...
public partial class Pinglun : ContentPage
{
    ...
    public Pinglun(NASMB.TYPES.Messagebs _msg)
	{
        ...
        if (DeviceDisplay.Current.MainDisplayInfo.Width > txtcontent.MaximumWidthRequest)
        {
            txtcontent.WidthRequest = txtcontent.MaximumWidthRequest - 50;
        }
        else
        {
            txtcontent.WidthRequest = DeviceDisplay.Current.MainDisplayInfo.Width - 50;
        }
        var cp = App.Current.MainPage as AppShell;
        view2.HeightRequest = cp.CurrentPage.Height-80;
